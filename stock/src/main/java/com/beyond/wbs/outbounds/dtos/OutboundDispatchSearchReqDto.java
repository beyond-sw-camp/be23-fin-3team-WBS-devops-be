...
@Setter
@NoArgsConstructor
public class OutboundDispatchSearchReqDto {
    private LocalDate dateFrom;
    private LocalDate dateTo;
    private UUID warehouseId;
    private String originType;
    private String dispatchNoKeyword;
